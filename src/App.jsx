...
function App() {
  ...
  return (
    <div className="w-full max-w-md h-38 mx-auto shadow-md rounded-lg px-4 py-3 my-8 mt-10 bg-gray-800 text-orange-600">
      <h1 className="text-white text-center text-2xl justify-center m-3">
        Password Genrator
      </h1>
